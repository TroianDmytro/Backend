...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'password123', description: 'Пароль пользователя (минимум 6 символов)' }),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '+380 (67) 123-45-67', description: 'Номер телефона пользователя', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateUserDto.prototype, "telefon_number", void 0);
