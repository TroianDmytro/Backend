...
const homework_submission_schema_1 = require("../homework/schemas/homework-submission.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: homework_submission_schema_1.HomeworkSubmission.name, schema: homework_submission_schema_1.HomeworkSubmissionSchema }
            ]),
        ],
