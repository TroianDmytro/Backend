...
let EmailService = EmailService_1 = class EmailService {
    ...
    async sendEmailChangeNotification(oldEmail, newEmail, verificationUrl) {
    ...
    async sendResetPasswordCode(to, code, name) {
        const userName = name || 'пользователь';
        const mailOptions = {
            from: process.env.EMAIL_FROM || 'noreply@example.com',
            to,
    ...
    async sendTeacherApprovalNotification(to, teacherName, status, rejectionReason) {
    ...
    async sendBlockNotification(to, teacherName, isBlocked, reason) {
    ...
    async sendSubscriptionCancellationNotification(to, userName, reason, immediate) {
    ...
    async sendSubscriptionActivationNotification(to, userName) {
    ...
    async sendSubscriptionExpirationNotification(to, userName) {
    ...
    async sendSubscriptionExpiringNotification(to, userName, expirationDate) {
    ...
    getApprovedTeacherTemplate(teacherName) {
        return `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; max-width: 600px; margin: 0 auto;">
    ...
    getRejectedTeacherTemplate(teacherName, reason) {
        return `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; max-width: 600px; margin: 0 auto;">
    ...
    getBlockedTeacherTemplate(teacherName, reason) {
        return `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; max-width: 600px; margin: 0 auto;">
    ...
    getUnblockedTeacherTemplate(teacherName) {
        return `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; max-width: 600px; margin: 0 auto;">
            <div style="background-color: #4CAF50; color: white; padding: 20px; text-align: center;">
